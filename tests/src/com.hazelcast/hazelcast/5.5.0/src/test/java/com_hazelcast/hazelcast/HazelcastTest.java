...
class HazelcastTest {
    ...
    void testAtomicLong() {
        ...
        try {
            // In OSS Hazelcast 5.5.0 CP subsystem is a licensed feature; verify the expected exception.
            assertThatThrownBy(() -> client.getCPSubsystem().getAtomicLong("counter"))
    ...
    void testLock() {
        ...
        try {
            // In OSS Hazelcast 5.5.0 CP subsystem is a licensed feature; verify the expected exception.
            assertThatThrownBy(() -> client.getCPSubsystem().getLock("my-distributed-lock"))
                    .isInstanceOf(UnsupportedOperationException.class);
        } finally {
            client.shutdown();
        }
